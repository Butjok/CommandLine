...
public partial class CommandLineBaseListener : ICommandLineListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterArgument([NotNull] CommandLineParser.ArgumentContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="CommandLineParser.argument"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitArgument([NotNull] CommandLineParser.ArgumentContext context) { }
	/// <summary>
